...
///
/// Sans argument :
///  - si Bible est déjà installé -> MAJ silencieuse + lancement (mode launch) ;
...
Future<int> runCli(List<String> args) async {
  ...
  if (opts['help'] as bool) {
    stdout.writeln(
      'bible-updater — installe, met à jour et lance Bible.\n',
    );
...
Future<int> _check(Layout? existing) async {
  if (existing == null) {
    stdout.writeln('Bible n\'est pas installé.');
    return 0;
  }
